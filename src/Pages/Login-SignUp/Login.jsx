    ...
    <div className=" w-full min-h-screen font-poppins bg-photo">
        ...
        <div className="absolute top-1/2 left-1/2 bg-gray-600 opacity-85 transform -translate-x-1/2 -translate-y-1/2 shadow-2xl md:w-lg w-fit rounded-md p-10">
            ...
            <form onSubmit={handleSubmit} className='flex flex-col justify-center'>
                ...
                <div className='flex justify-center mt-3'><button className=" text-black bg-gray-200 px-32 focus:bg-gray-600 md:px-40 text-lg rounded-2xl py-1 border-2">Sign In</button></div>
                <p className='text-center mt-3 text-green-300 hover:underline'><Link to='/reset-password'>Forgot Password</Link></p>
                <p className='text-center text-white mt-3'>Don't Have an Account? <Link to='/sign-up' className='text-green-300 hover:underline ml-1'>Sign Up</Link></p>
            </form>
        </div>
    </div>
    ) ;
